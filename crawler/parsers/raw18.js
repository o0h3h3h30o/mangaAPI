/**
 * Parser for raw18.diy (Japanese manga - フルカラー/Full-color)
 *
...
const CURRENT_DOMAIN = 'raw18.diy';
const BASE_URL = `https://${CURRENT_DOMAIN}`;

// All legacy domains (add old domain here when CURRENT_DOMAIN changes)
const LEGACY_DOMAINS = ['raw18.info', 'raw18.link', 'raw18.rest', 'raw18.win', 'raw18.cloud', 'raw18.men', 'raw18.lol', 'raw18.pics', 'raw18.cam', 'raw18.work'];
